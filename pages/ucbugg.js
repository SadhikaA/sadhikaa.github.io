      ...
      <Layout>
        ...
        <div className={styles.rightColumn}>
          ...
          <div className={styles.imageContainer}>
            <Image src={storyboard2} alt="storyboard2" width={300} className={styles.mobileImage}/>
            <Image src={final} alt="storyboard" width={300} className={styles.mobileImage}/>
          </div>
          ...
          <div className={styles.imageContainer}>
            <Image src={rig} alt="rig" width={650} className={styles.mobileImage}/>
          </div>
          ...
          <div className={styles.imageContainer}>
            <Image src={toon} alt="toon" width={650} className={styles.mobileImage}/>
          </div>
          <h4>Animation</h4>
